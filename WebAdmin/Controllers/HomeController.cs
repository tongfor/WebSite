...
namespace WebAdmin.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public HomeController(IAdminOperateLogService operateLogService, IAdminBugService adminBugService, IAdminUserService adminUserService, IAdminRoleService adminRoleService,
            IAdminLoginLogService adminLoginLog, IAdminMenuService adminMenuService, ILogger<HomeController> logger, IOptionsSnapshot<SiteConfig> options, IOptionsSnapshot<GatherConfig> gatherOptions) : base(operateLogService, adminBugService, adminMenuService, options, gatherOptions)
        {
