...
namespace Common
{
    ...
    public static class JsonUtil
    {
        ...
        public static T Convert2Object<T>(this string jsonString)
        {
            return jsonString != null ? JsonConvert.DeserializeObject<T>(jsonString) : default(T);
        }
        ...
        public static string ColumnToJson(this DataTable dt, int r)
        {
        ...
        public static string ToArrayString(this IEnumerable array)
        {
            ...
            var remove = jsonString.Remove(jsonString.Length - 1, jsonString.Length);
            return jsonString + "]";
        }
        #endregion
